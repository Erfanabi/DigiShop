...
function BottomNavigation() {
  ...
  return (
    <div className="block md:hidden bg-stone-50 h-16 w-full rounded-t-xl shadow-[0_-4px_8px_0_rgba(0,0,0,0.1)] fixed bottom-0 z-[100] left-0 right-0 overflow-hidden">
      <ul className="flex items-center h-full gap-x-3">
        {items.map((item) => {
          return (
            <li
              key={item.id}
              className="cursor-pointer flex-auto text-center h-full"
            ...
            >
              ...
              >
                <span
                  className={`${
                    open == item.id ? "text-slate-800" : "text-gray-400"
                  }`}
                >
                  {item.icon}
                </span>
                <span className="text-sm sm:text-lg mr-2 font-bold">
                  {open == item.id ? item.title : ""}
                </span>
              </a>
            </li>
          );
...
{
  /* <li className="cursor-pointer flex-1 text-center h-full">
<a
  href="#"
  className="inline-flex items-center justify-center h-full"
>
